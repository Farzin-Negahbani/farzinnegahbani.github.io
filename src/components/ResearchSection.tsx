...
export function ResearchSection() {
  return <section id="research" className="py-24 bg-muted/30">
      <div className="section-container">
        <div className="text-center mb-16">
          <h2 className="section-title">Research Focus</h2>
          <p className="section-subtitle mx-auto">My research focuses on applied neuromodulation, integrating neural data and computational methods to optimize Deep Brain Stimulation in clinical settings.</p>
        </div>

        <div className="grid md:grid-cols-2 gap-6">
          {researchAreas.map((area, index) => <div key={area.title} className="card-academic group" style={{
